...
/**
 * Created with IntelliJ IDEA. User: okey Date: 14-4-2 Time: 下午4:50 To change
...
public class ReadFileThread extends Thread {
	...
	public ReadFileThread(ReaderFileListener processPoiDataListeners,
			long start, long end, String file) {
